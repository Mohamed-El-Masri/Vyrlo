// api = https://virlo.vercel.app//profile/67a899f51909bc60ccdc26a7
 


// class  AuthService {
//     static API_BASE = 'https://virlo.vercel.app/'; // Add trailing slash
...
//         const response = await AuthService.makeRequest(`/profile/${user._id}`, {
//             method: 'PUT',
...
//         // Extract the first profile object (since response is an array)
//         const profile = profileData[0];
        
//         // Populate form fields
//         document.getElementById('Name').value = profile.userId.username;
//         document.getElementById('Email').value = profile.userId.email;
...
//         // Populate social accounts (example for LinkedIn and GitHub)
...
//                 socialInputs[index].value = account.url;
//                 // Update label text if needed
//                 socialInputs[index].previousElementSibling.textContent = account.platform;
//             }
//         });
...
{
    const response=await fetch("https://virlo.vercel.app//profile/67a899f51909bc60ccdc26a7");
    const data=await response.json();
    console.log(data);
}
getinfo()